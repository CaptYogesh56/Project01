...
<body>
    ...
    <div class="row mt-5">
        ...
        <div class="row">
            ...
            @endif
        <div class="col-lg-7">
            <form action="{{ route('injectors.add') }}" method="POST">
                @csrf
                ...
                <div class="m-3 d-flex">
                    <label for="flow_sensor_id" class="col-lg-2 form-label">Flow Sensor ID</label>
                    <input type="text" name="flow_sensor_id" class="form-control">
                </div>
                <div class="m-3 d-flex">
